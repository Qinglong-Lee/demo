...
public class AspectBean$$EnhancerBySpringCGLIB$$cdec3835 extends AspectBean implements SpringProxy, Advised, Factory {
   ...
   private static final Method CGLIB$testAspect$0$Method;
   private static final MethodProxy CGLIB$testAspect$0$Proxy;
   ...
   static void CGLIB$STATICHOOK15() {
      ...
      Class var0 = Class.forName("com.example.demo.spring.aop.aspect.AspectBean$$EnhancerBySpringCGLIB$$cdec3835");
      Class var1;
      ...
      CGLIB$testAspect$0$Method = ReflectUtils.findMethods(new String[]{"testAspect", "()V"}, (var1 = Class.forName("com.example.demo.spring.aop.aspect.AspectBean")).getDeclaredMethods())[0];
      CGLIB$testAspect$0$Proxy = MethodProxy.create(var1, var0, "()V", "testAspect", "CGLIB$testAspect$0");
   }

   final void CGLIB$testAspect$0() {
      super.testAspect();
   }

   public final void testAspect() {
      ...
      if(var10000 != null) {
         var10000.intercept(this, CGLIB$testAspect$0$Method, CGLIB$emptyArgs, CGLIB$testAspect$0$Proxy);
      } else {
         super.testAspect();
      }
   }
   ...
   public static MethodProxy CGLIB$findMethodProxy(Signature var0) {
      ...
      case -692328533:
         if(var10000.equals("testAspect()V")) {
            return CGLIB$testAspect$0$Proxy;
         }
         break;
      case -508378822:
   ...
   public AspectBean$$EnhancerBySpringCGLIB$$cdec3835() {
      CGLIB$BIND_CALLBACKS(this);
   }
   ...
   private static final void CGLIB$BIND_CALLBACKS(Object var0) {
      AspectBean$$EnhancerBySpringCGLIB$$cdec3835 var1 = (AspectBean$$EnhancerBySpringCGLIB$$cdec3835)var0;
      if(!var1.CGLIB$BOUND) {
   ...
   public Object newInstance(Callback[] var1) {
      ...
      AspectBean$$EnhancerBySpringCGLIB$$cdec3835 var10000 = new AspectBean$$EnhancerBySpringCGLIB$$cdec3835();
